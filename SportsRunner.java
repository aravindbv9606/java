class SportsRunner  {
    public static void main(String[] args) {
        ...
        double [] result = Sports.work(data);
        ...
        boolean [] worth= Sports.iswork(isTrue);
