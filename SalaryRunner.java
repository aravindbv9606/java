class SalaryRunner  {
    public static void main(String[] args) {
		System.out.println("salary employes");
        double [] price = {100.56, 20670.75, 34500.0,23456};  
        double [] result = Salary.work(price);
        ...
        boolean [] worth= Salary.iswork(isTrue);
