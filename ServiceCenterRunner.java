class ServiceCenterRunner  {
    public static void main(String[] args) {
        ...
        int[] rang= ServiceCenter.display(name);
        ...
        float [] color= ServiceCenter.dise(size);
        ...
        boolean [] worth= ServiceCenter.iswork(isTrue);
		...
		char[] grade = {'a','b','c'};  
        char [] averge= ServiceCenter.dis(grade);
