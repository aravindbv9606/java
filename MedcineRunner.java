class MedcineRunner  {
    public static void main(String[] args) {
		System.out.println("Medcine list of products");
        double [] price = {100.56, 20670.75, 34500.0,23456};  
        double [] result = Medcine.work(price);
        ...
        boolean [] worth= Medcine.iswork(isTrue);
